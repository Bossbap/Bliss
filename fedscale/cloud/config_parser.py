...
parser.add_argument("--test_bsz", type=int, default=128, help="test batch size")
...
parser.add_argument("--num_loaders", type=int, default=2, help="tells PyTorch how many separate worker processes to spawn in the creation of minibatches from a dataset")
